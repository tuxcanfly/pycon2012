...
import logging
logger = logging.getLogger('hello_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by HelloWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseHelloWindow object.
        """
        builder = get_builder('HelloWindow')
        new_object = builder.get_object("hello_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a HelloWindow object with it in order to finish
        initializing the start of the new HelloWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.hello")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('hello')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for hello."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for hello."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the HelloWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the HelloWindow is closed."""
