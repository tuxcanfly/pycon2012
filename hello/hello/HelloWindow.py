...
class HelloWindow(Window):
    ...
    def finish_initializing(self, builder): # pylint: disable=E1002
        ...
        self.widget_nameentry = self.builder.get_object('nameentry')
        self.widget_hellolabel = self.builder.get_object('hellolabel')
        self.widget_okbutton = self.builder.get_object('okbutton')

    def on_okbutton_clicked(self, widget):
        text = self.widget_nameentry.get_text()
        self.widget_hellolabel.set_text('Hello %s' % (text))
